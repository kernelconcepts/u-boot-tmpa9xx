...
#define CONFIG_EXTRA_ENV_SETTINGS	"update_kernel=dhcp uImage-topasa900; nand erase 0x80000 0x300000; nand write ${fileaddr} 0x80000 0x300000\0" \
					"update_rootfs=dhcp rootfs-topasa900; nand erase 0x380000; nand write ${fileaddr} 0x380000 ${filesize}\0"
