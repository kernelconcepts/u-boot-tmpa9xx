...
#define CONFIG_ETHADDR			00:11:22:66:55:44 
...
#define CONFIG_SYS_PROMPT		"Tonga2>"	/* Monitor Command Prompt */
...
#define CONFIG_BOOTCOMMAND		"run bootargs_base; nand read 0x40600000 0x80000 0x300000; bootm 0x40600000"
...
#define CONFIG_EXTRA_ENV_SETTINGS	"update_kernel=dhcp uImage-tonga; nand erase 0x80000 0x300000; nand write ${fileaddr} 0x80000 0x300000\0" \
					"update_rootfs=dhcp rootfs-tonga; nand erase 0x380000; nand write ${fileaddr} 0x380000 ${filesize}\0" \
                                        "bootargs_base=setenv bootargs console=ttyS0,115200n8 root=/dev/mtdblock2 rootfstype=jffs2 ethaddr=${ethaddr}\0"
