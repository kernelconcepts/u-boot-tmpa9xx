...
#define CONFIG_EXTRA_ENV_SETTINGS           "update_kernel_dhcp=dhcp uImage-topasa900; nand erase kernel; nand write ${fileaddr} kernel            \0" \
                                            "update_rootfs_dhcp=dhcp rootfs          ; nand erase rootfs; nand write ${fileaddr} rootfs ${filesize}\0" \
                                            "update_kernel_tftp=tftp uImage-topasa900; nand erase kernel; nand write ${fileaddr} kernel            \0" \
